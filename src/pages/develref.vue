...
import Worke from "../components/develref_child/worke";
import myPolicy from "../components/develref_child/policy";
import myEvaluate from "../components/develref_child/evaluate";
import Indicators from "../components/develref_child/indicators";
export default {
  components: {
    Tab,
    Worke,
